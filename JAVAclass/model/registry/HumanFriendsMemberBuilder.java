...
public class HumanFriendsMemberBuilder {
    ...
    public String printAnimalTypeDescriptions() {
        ...
        // sb.append(dogs.printPetTypes()).append(", ").append(cats.printPetTypes()).append(", ").append(hamsters.printPetTypes()).append(", ").append(horses.printPackAnimalsTypes()).append(", ").append(camels.printPackAnimalsTypes()).append(", ").append(donkeys.printPackAnimalsTypes());
        // sb.append(dogs.printPetTypes()).append(", ").append(horses.printPackAnimalsTypes()).append(", ");
        sb.append(dogs.printPetTypes()).append(", ").append(horses.printPackAnimalsTypes()).append(", ");
